...
<!--  <tr>
  ...
  <tr>
    <td>
        <span style="text-align:center; font-size: 13px; color: #0A0A04; line-height:18px; font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif">Se a realizado la publicacion de de un archivo adjunto en el programa <b><?php echo $adjunto->item->title; ?><b/></span></td>
  </tr>
</table>
<table width="520"border="0" align="center" cellspacing="0" cellpadding="0">
      <tr>
        <td width="90" height="28"  style="text-align:center; font-size: 15px; padding: 5px; color: #FFFFFF; font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif"><strong>Nombre archivo</strong></td>
        <td width="9" height="43"></td>
        <td width="90" height="28"  style="text-align:center; font-size: 15px; padding: 5px; color: #FFFFFF; font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif"><strong>Nombre de usuario publicador</strong></td>
        <td width="9" height="43"></td>
      </tr>
        <tr>
        <td height="5">
    ...
    <table width="520"border="0" align="center" cellspacing="0" cellpadding="0">
      <tr>
      <td width="90" bgcolor="#242424" height="28"  style="text-align:center; font-size: 15px; padding: 5px; color: #A8A7AC; font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif"><strong><?php echo $adjunto->filename;?></strong></td>
      <td width="9" height="43"></td>
