...
//          '<controller:\w+>/<action:\w+>'=>'<controller>/<action>',
                'programa/view/<id>' => 'programa/view',
                'programa/edit/<id>' => 'programa/edit',
                'programa/subirArchivo/<id>' => 'programa/subirArchivo',
                'programa/ActualizaEstado/<programa>/<estado>' => 'programa/ActualizaEstado'
            ),
        ),
        'db' => array(
            'connectionString' => 'mysql:host=localhost;dbname=wwwaerov_appaerovision;unix_socket:/path/to/socket/mysql.sock',
            'emulatePrepare' => true,
