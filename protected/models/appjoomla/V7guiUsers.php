...
/**
 * This is the model class for table "v7gui_users".
 *
 * The followings are the available columns in table 'v7gui_users':
 * @property integer $id
 ...
 */
class V7guiUsers extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('params, username, password', 'required'),
	 ...
	 * @return V7guiUsers the static model class
	 */
